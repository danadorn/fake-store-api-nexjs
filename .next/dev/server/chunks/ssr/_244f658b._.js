...
;
;
const BASE_URL = `${("TURBOPACK compile-time value", "https://api.escuelajs.co")}/api/v1`;
const formSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    name: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(3, "Category name at least 3 characters long")
});
async function insertCategory(data) {
    ...
    console.log("Insert Category:", resData);
    return resData;
}
function CategoryForm() {
    ...
    async function onSubmit(values) {
        const fileInput = document.querySelector("#category-image-input");
...
//# sourceMappingURL=_244f658b._.js.map